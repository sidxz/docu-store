...
- `page_created()` → inserts page read model with empty compounds list
- `compounds_added()` → updates compounds using `.model_dump(mode="json")`
...
This will:
- Subscribe to Page.Created and Page.CompoundsAdded events from KurrentDB
